...
template <class C> C* string_to_new (String s) {
 ...
 // Haccs <-> Files
static inline void hacc_to_file (Hacc* h, Either_String f, uint ind = 0) {
...
static inline void file_from_hacc (Either_String f, Hacc* h, uint ind = 0) {
...
static inline Hacc* file_to_hacc (Either_String f) {
 ...
 // Objects <-> Files
template <class C> void to_file (const C& v, Either_String f, uint ind = 0) {
...
template <class C> void file_from (Either_String f, const C& v, uint ind = 0) {
    to_file<C>(v, f, ind);
}
