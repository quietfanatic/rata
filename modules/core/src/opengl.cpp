...
OPENGL_THUNK(glGenFramebuffers, void, GLsizei, GLuint*)
OPENGL_THUNK(glBindFramebuffer, void, GLenum, GLuint)
OPENGL_THUNK(glDeleteFramebuffers, void, GLsizei, GLuint*)
OPENGL_THUNK(glGenRenderbuffers, void, GLsizei, GLuint*)
OPENGL_THUNK(glBindRenderbuffer, void, GLenum, GLuint)
OPENGL_THUNK(glDeleteRenderbuffers, void, GLsizei, GLuint*)
OPENGL_THUNK(glRenderbufferStorage, void, GLenum, GLenum, GLsizei, GLsizei)
OPENGL_THUNK(glFramebufferRenderbuffer, void, GLenum, GLenum, GLenum, GLuint)
