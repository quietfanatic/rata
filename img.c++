...
void load_img () {
	...
	good &= img::heart.sfi.LoadFromFile("img/heart;4,8.png"); img::heart.sfi.SetSmooth(0);
	...
	good &= img::hit_damagable.sfi.LoadFromFile("img/hit-damagable;8,8.png"); img::hit_damagable.sfi.SetSmooth(0);
	...
	good &= img::patroller.sfi.LoadFromFile("img/patroller;8,16.png"); img::patroller.sfi.SetSmooth(0);
	img::patroller.x = 8; img::patroller.y = 16;
	good &= img::rat.sfi.LoadFromFile("img/rat;6,8.png"); img::rat.sfi.SetSmooth(0);
	...
	good &= img::tiles.sfi.LoadFromFile("img/tiles;8,8.png"); img::tiles.sfi.SetSmooth(0);
